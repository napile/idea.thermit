...
public class SaveMetaTargetDialog extends DialogWrapper
{
	...
	public SaveMetaTargetDialog(final Component parent, final ExecuteCompositeTargetEvent event, final ThermitConfigurationBase antConfiguration, final AntBuildFile buildFile)
	{
		super(parent, true);
	...
	{
		return "#com.intellij.thermit.explorer.SaveMetaTargetDialog";
	}
