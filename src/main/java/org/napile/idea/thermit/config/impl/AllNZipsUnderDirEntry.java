...
public class AllNZipsUnderDirEntry implements AntClasspathEntry
{
	@NonNls
	private static final String JAR_SUFFIX = ".nzip";
	...
	public AllNZipsUnderDirEntry(final File dir)
	{
		myDir = dir;
	}

	public AllNZipsUnderDirEntry(final String osPath)
	{
	...
	{
		return new AllNZipsUnderDirEntry(file.getPath());
	}
