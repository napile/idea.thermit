...
public class AntBeforeRunTask extends BeforeRunTask<AntBeforeRunTask>
{
	...
	public boolean equals(Object o)
	{
		...
		if(myAntFileUrl != null ? !myAntFileUrl.equals(that.myAntFileUrl) : that.myAntFileUrl != null)
			return false;
		if(myTargetName != null ? !myTargetName.equals(that.myTargetName) : that.myTargetName != null)
			return false;
