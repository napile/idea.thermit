...
public class AntInstallation {
  ...
  @NonNls public static final String PATH_TO_ANT_JAR = "lib/thermit.jar";
  @NonNls public static final String LIB_DIR = "lib";
  @NonNls public static final String ANT_JAR_FILE = "thermit.jar";
  @NonNls public static final String VERSION_RESOURCE = "org/apache/tools/thermit/version.txt";
